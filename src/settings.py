...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {"__PRETEXT__":"Additionally, images in *identification-test* and *identification-train* splits contain information about ***cow_id***"}
